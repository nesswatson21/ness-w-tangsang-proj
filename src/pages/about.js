...
import profilePic from "../../public/images/profile/Ness_ProXDR.png";
                    ...
                    <div className="grid w-full grid-cols-9 gap-16 sm:gap-8">
                        <div className="col-span-3 flex flex-col items-start justify-start 2xl:col-span-4 xl:col-span-4 lg:order-2 lg:col-span-9 md:order-2 md:col-span-9">
                            ...
                            <p className="font-medium text-dark/75">
                                Hello, my name is Ness Watson Tangsang and Im Full Stack Developer, from a young age, I was deeply enthusiastic about technology, sparking an interest that began in my childhood. I studied computer subjects in school during those early days, where I learned programming languages like GW-BASIC, Atari BASIC and worked with floppy disks on systems running Windows 95 and NT. Often, my mom would pick me up from school and take me to her office, where I eagerly absorbed even more knowledge. These experiences continued into my time in grade 11 , exploring tools like Java, HTML,CSS FoxPro learning to design databases, write queries, and build functional systems that felt like real software in my hands laying the foundation for my lifelong passion for tech.
                            </p>
                            <p className="font-medium my-4 text-dark/75">
                                I have always been curious about how things
                                work, which led me to pursue a degree in
                                development. Over the years, I have honed my
                                skills in HTML, CSS, JavaScript, Python, React, and
                                NextJS through various online courses,
                                workshops, and personal projects..
                            </p>
                            <p className="font-medium my-4 text-dark/75">
                                As a web developer, I believe that great design is about more than just aesthetics  its about creating experiences that are intuitive, accessible, and meaningful for users. Whether Im working on a small website or a complex web application, I always strive to put the user first.
                            </p>
                            <p className="font-medium my-4 text-dark/75">
