                    ...
                    <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
                        ...
                        <div className="col-span-6 sm:col-span-12">
                            <Project
                                ...
                                img={project2}
                                summary="Developed a Slack recreation project using JavaScript, Node.js, React, implementing features such as real-time messaging, user authentication, and channel-based communication."
                                link="https://mellifluous-sawine-7134b3.netlify.app/"
                                type="Created ChatHive Project"
