      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between m1-4 xs:ml-2">
          <Details
            ...
            place="AU,Tamil Nadu"
            info="Studied core subjects such as Artificial Intelligence, Machine Learning, AI Algorithms, Multi-Media ,Networking, Database Management, Web Development, and Operating Systems, while completing hands-on projects in hardware configuration, software development, and network design; also learned French as part of the curriculum, focusing on basic communication, reading, and technical vocabulary."
          />
          <Details
            type="Hardware Course and PC maintenance & Networking"
            place="Guwahati, Assam"
            info="The Hardware and PC Maintenance course provided both foundational and advanced knowledge in assembling, troubleshooting, and maintaining desktop and laptop systems. It covered key hardware components such as motherboards, CPUs, RAM, hard drives, power supplies, and peripherals, along with BIOS/UEFI configuration, operating system installation/upgrades, hardware fault diagnosis, and preventive maintenance. I also gained hands-on experience installing and configuring Linux operating systems including Kali Linux, Ubuntu, Fedora, Debian, and CentOS. In addition, the training introduced networking fundamentals with Cisco technologies, covering concepts such as LAN/WAN setup, IP addressing, subnetting, and router/switch configuration. Practical sessions also involved system optimization, virus removal, and data backup solutions."
          />
          <Details
