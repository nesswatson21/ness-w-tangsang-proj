                    ...
                    <div className="flex items-center justify-between w-full lg:flex-col">
                        ...
                        <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
                            ...
                            <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                                                                Hello, I&apos;m Ness Watson Tangsang, I am a Full Stack Developer who&apos;s passionate & ethusiastic about creating web application. I am into web developement from past 3 years and I have experience working on serveral real world end to end project using HTML, CSS, Javascript, Python,  React JS, Typescript, Redux, Web3.js ,React Context API & Firebase . I have done my graduation in Bachelors of Science in Information Technology (Tamil Nadu). And I have internships experience as a React Developer in Blockchain Technology.
